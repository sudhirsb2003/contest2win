  ...
  module Helpers
    module FormOptionsHelper
      ...
      def country_options_for_select(selected = nil, priority_countries = nil)
        ...
        return country_options + options_for_select(NEW_COUNTRIES, selected)
      end
      # All the countries included in the country_options output.
      NEW_COUNTRIES = ["Afghanistan","Åland Islands","Albania","Algeria","American Samoa","Andorra","Angola",
        ...
        "Yemen","Zambia","Zimbabwe"] unless const_defined?("NEW_COUNTRIES")
    end
