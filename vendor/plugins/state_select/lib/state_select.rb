module ActionView::Helpers::FormOptionsHelper
  ...
  def state_options_for_select(selected = nil, country = 'US')
    state_options = ""
    if country
      state_options += options_for_select(eval(country.gsub(/\W+/, '_').upcase+'_STATES'), selected)
    end
  ...
  GERMANY_STATES=["Baden-Wurttemberg", "Bayern", "Berlin", "Brandenburg", "Bremen", "Hamburg", "Hessen", "Mecklenburg- Vorpommern", "Niedersachsen", "Nordrhein-Westfalen", "Rhineland- Pflaz", "Saarland", "Sachsen", "Sachsen-Anhalt", "Schleswig- Holstein", "Thuringen"]  unless const_defined?("GERMAN_STATES")
  SOUTH_AFRICA_STATES=["Western Cape","Northern Cape","Free State","Gauteng","Eastern Cape","KwaZulu-Natal","Limpopo","Mpumalanga","North West"]
